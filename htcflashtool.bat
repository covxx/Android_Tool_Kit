...
:MENU
cls
ECHO  APRIL 22/2016 UPDATE
ECHO  This is VERY old, if you're using this it may not work for what you want it to
ECHO  As always im not responsible for any damage done, use at your own risk
ECHO 
ECHO                    *************************
ECHO                   *       flashing Tool     *
ECHO                  *           @covxx          *
